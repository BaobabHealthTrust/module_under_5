...
Q.1.2. Was DPT-HepB-Hib 1 vaccine given at 6 weeks or later? [pos: 7, tt_onUnLoad: showCategory("Immunization Record"); __$("category").style.fontSize = "30px", condition: <%= @patient.age_in_months > 1.5 and !@patient.dpt1.downcase == "yes" %>]
O.1.2.1. No
O.1.2.2. Yes
...
Q.1.3. Was DPT-HepB-Hib 2 vaccine given at 1 month after first dose? [pos: 9, tt_onUnLoad: showCategory("Immunization Record"); __$("category").style.fontSize = "30px", condition: <%= @patient.age_in_months > 2 and !@patient.dpt2.downcase == "yes" %>]
O.1.3.1. No
O.1.3.2. Yes
...
Q.1.4. Was DPT-HepB-Hib 3 vaccine given at 1 month after second dose? [pos: 11, tt_onUnLoad: showCategory("Immunization Record"); __$("category").style.fontSize = "30px", condition: <%= @patient.age_in_months > 2 and !@patient.dpt3.downcase == "yes" %>]
O.1.4.1. No
O.1.4.2. Yes
...
Q.1.5. PCV 1 vaccine given at 6 weeks or later? [tt_onUnLoad: showCategory("Immunization Record"); __$("category").style.fontSize = "30px", pos: 13, condition: <%= @patient.age_in_months > 1.5 and !@patient.pcv1.downcase == "yes" %>]
O.1.5.1. No
O.1.5.2. Yes
...
Q.1.6. PCV 2 vaccine given at 1 month after first dose? [tt_onUnLoad: showCategory("Immunization Record"); __$("category").style.fontSize = "30px", pos: 15, condition: <%= @patient.age_in_months > 1.5 and !@patient.pcv2.downcase == "yes" %>]
O.1.6.1. No
O.1.6.2. Yes
...
O.1.13.1. Negative
O.1.13.2. Positive
Q.1.13.2.1. Child's current HIV status [tt_onUnLoad: showCategory("Immunization Record"); __$("category").style.fontSize = "30px", pos: 30]
