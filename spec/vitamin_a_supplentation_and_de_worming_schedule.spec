...
Q.1.3.2. Visit date [field_type: date, tt_onLoad: if(!tt_cancel_destination.match("skip_flow")){tt_cancel_destination += "&skip_flow=true"}; showCategory("Supplementation"); __$("category").style.fontSize = "30px", pos: 7]
