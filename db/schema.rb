...
ActiveRecord::Schema.define(:version => 0) do
  ...
  add_index "active_list", ["active_list_type_id"], :name => "active_list_type_of_active_list"
  add_index "active_list", ["concept_id"], :name => "concept_active_list"
  add_index "active_list", ["creator"], :name => "user_who_created_active_list"
  add_index "active_list", ["person_id"], :name => "person_of_active_list"
  add_index "active_list", ["start_obs_id"], :name => "start_obs_active_list"
  add_index "active_list", ["stop_obs_id"], :name => "stop_obs_active_list"
  add_index "active_list", ["voided_by"], :name => "user_who_voided_active_list"
  ...
  add_index "active_list_allergy", ["reaction_concept_id"], :name => "reaction_allergy"
  ...
  add_index "active_list_type", ["creator"], :name => "user_who_created_active_list_type"
  add_index "active_list_type", ["retired_by"], :name => "user_who_retired_active_list_type"
  ...
  add_index "drug_ingredient", ["drug_id", "drug_substance_id"], :name => "drugs_and_drug_substance"
  add_index "drug_ingredient", ["drug_substance_id"], :name => "drug_substance"
  ...
  add_index "drug_substance", ["concept_id"], :name => "primary_drug_ingredient_concept"
  add_index "drug_substance", ["creator"], :name => "drug_ingredient_creator"
  add_index "drug_substance", ["retired_by"], :name => "user_who_retired_drug"
  add_index "drug_substance", ["route"], :name => "route_concept"
  ...
  add_index "hl7_in_archive", ["message_state"], :name => "hl7_in_archive_message_state_idx"
  ...
  add_index "logic_rule_definition", ["changed_by"], :name => "changed_by for rule_definition"
  add_index "logic_rule_definition", ["creator"], :name => "creator for rule_definition"
  add_index "logic_rule_definition", ["name"], :name => "name", :unique => true
  add_index "logic_rule_definition", ["retired_by"], :name => "retired_by for rule_definition"
  ...
  add_index "logic_rule_token", ["uuid"], :name => "logic_rule_token_uuid", :unique => true
  ...
  add_index "logic_token_registration", ["changed_by"], :name => "token_registration_changed_by"
  add_index "logic_token_registration", ["creator"], :name => "token_registration_creator"
  add_index "logic_token_registration", ["uuid"], :name => "uuid", :unique => true
  ...
  add_index "logic_token_registration_tag", ["token_registration_id"], :name => "token_registration_tag"
  ...
  create_table "program_encounter_details", :id => false, :force => true do |t|
    t.integer "encounter_id"
    t.integer "program_encounter_id"
    t.string  "program_id",           :limit => 45
  end
